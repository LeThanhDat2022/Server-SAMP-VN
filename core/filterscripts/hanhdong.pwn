...
{
	SendClientMessage(playerid, COLOR_GREEN, "Lenh liet ke sang:");
	...
	SendClientMessage(playerid, COLOR_GREEN, "Su dung /stopani de dung hanh dong.");
	return 1;
}
...
CMD:sit(playerid, params[])
{
	...
	case 6:PlayAnimEx(playerid, "INT_OFFICE", "OFF_Sit_Type_Loop", 4.0, 1, 1, 1, 1, 1, 1);
