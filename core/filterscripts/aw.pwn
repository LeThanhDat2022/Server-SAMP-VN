...
public ExecuteHackerAction( playerid )
{
    ...
    format( String, sizeof( String ), "WARNING: %s Co the dang su dung hack vu khi (%s) [%d].", NameStr, WeaponName, HackWarnings-WEAPON_HACKER_WARNINGS );
    CallRemoteFunction( "SendAdminMessage", "ds", LIGHTRED, String );

    if( HackWarnings >= WEAPON_HACKER_WARNINGS )
    {
        format( String, sizeof( String ), "WARNING: %s Auto Banned, Ly Do: Weapon Hacking (%s).", NameStr, WeaponName );
